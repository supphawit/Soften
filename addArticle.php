...
?>
  ...
  <head>
    ...
    <title>คนชอบเที่ยว I LIKE TRAVEL | Add Article</title>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
          ...
          <div class="row2">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
              ...
              <form role="form" id="addArticle" name="addArticle" method="post">

                <div class="form-group">

                  <label class="control-label" for="header">Header</label>
                  <input type="text" name="header" id="header" class="form-control input-lg" >
                ...
                <div class="row">
                  <div class="col-xs-3 col-sm-3 col-md-3">
                    <button class="btn" name="btn_add" id="btn_add">เพิ่มบทความ</button>
                  </div>
                </div>
      ...
      $(document).ready(() => {
        ...
        $("#forgetPass").click(async (e) => {
         ...
         $("#addArticle").submit(async (e) => {
          ...
          // console.log(picArray[4]);
          // console.log(picArray[5]);
          // console.log(pic.length);
          // Post 
          const response = await $.post(
            'action/insertArticle.php', {
              header: header,
              content: content,
              status: status,
              maxPic: maxPic,
          ...
          if(response.add.success == true){
            $("#err_pic").show(
              setTimeout(() => window.location.href = "KnowledgeResource.php?" , 0)
            );
          }
        });
      });
