  ...
  <body style="background-color:#fff3ed">
            ...
            $active =0;
              while($row = $news->fetch()){
                if( $active === 0){
                  ...
                  echo "<a href='view.php?showModal=0&news_id=". $row['news_id']."'><p>".$row['title']. " </p></a></div></div></div>";
                  $active++;
                }else{
    ...
    if(empty($_GET['more'])){
      ...
      while($tableDetails = $tablenews->fetch()){
          ...
          echo "<a href='index.php?showModal=0&more=". $getmore ."#a".$more."'><button type='button'  id='more' class='btn btn-pink ' >More</button></a>";
          echo "</div>";
   ?>
